# Smart_Bourse Installer v30
# Main integration - all-in-one command
...
def install():
    print()
    print("=" * 75)
    print("  Smart_Bourse Installer v30 - Main Integration")
    print("=" * 75)
    print()
    ...
    if target.exists():
        try:
            (target.with_suffix(".py.bak")).write_text(
                target.read_text(encoding="utf-8"), encoding="utf-8")
        except Exception:
            pass

    target.write_text(MAIN_PY, encoding="utf-8")
    print("  [OK]   main.py (9 phases)")
    ...
    print()
    print("  This runs everything with one command.")
    print()
